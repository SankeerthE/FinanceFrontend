...
async function fetchData(id) {
    try {
        ...
        headers.append('Authorization', 'Bearer ' + localStorage.getItem("token")) // Add your authorization token
...
function addContent() {
    ...
    apps.forEach((app) => {
        let row = document.createElement("tr")
            ...
            btnDoc.type = "button"
            btnDoc.value = app.application_number
            btnDoc.innerHTML = "View"+ '&nbsp' + "Docs"
